...
public class Generator {
     ...
     */
    public static String generateProblem(JsonInput.ProblemParameters params) {
        ...
        ArrayList<ArrayList<Pair<Integer, Integer>>> lDemand = new ArrayList<>();
    ...
    private static String generateHeaders(String out, double[] map, double[] patient, int amb, int hosp) {
        ...
        String problemName = out.substring(out.lastIndexOf("/") + 1);
        StringBuilder s = new StringBuilder("(define (problem " + problemName + ")\n");
    ...
    private static String generateMap(double[] map, ArrayList<ArrayList<Pair<Integer, Integer>>> locationDemand){
        ...
        ArrayList<Pair<Integer, Integer>> posRoads = generateRoads(nodes);
        Collections.shuffle(posRoads);
        ArrayList<Pair<Integer, Integer>> posCoord = generateCoord(nodes);
     ...
     * @return ArrayList with all possible roads
     */
    private static ArrayList<Pair<Integer, Integer>> generateRoads(int nodes){
     ...
     *
     * @param nodes Number of nodes
     * @return ArrayList with all possible coordinates
     */
    private static ArrayList<Pair<Integer, Integer>> generateCoord(int nodes){
